...
int main()
{
    ...
    while (T --) {
        long long n;
        scanf("%lld",&n);
        printf("%lld\n",linear_seq::gao(VI{4,6,499122186,249561104,873463836,811073585,218366040,826671268,740884789,113082958,668746869,4876462,506437893,759658887,141248073,211880301,317836835,476788020,216125389,324319155,486740876},n));
    }
    return 0;
}
